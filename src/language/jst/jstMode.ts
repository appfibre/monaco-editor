...
class JSONDiagnosticsAdapter extends languageFeatures.DiagnosticsAdapter<JstWorker> {
	constructor(
		languageId: string,
		worker: languageFeatures.WorkerAccessor<JstWorker>,
...
export function setupMode(defaults: LanguageServiceDefaults): IDisposable {
	...
	const worker: languageFeatures.WorkerAccessor<JstWorker> = (
		...uris: Uri[]
	): Promise<JstWorker> => {
